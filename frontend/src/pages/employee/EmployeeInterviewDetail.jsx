          ...
          <div className="flex flex-col gap-3">
            {(cvExperiences || []).map((exp, idx) => (
              <div key={idx} className="rounded-lg border border-slate-200 bg-slate-50/50 p-3">
                ...
                {exp.description ? (
                  <div className="mt-2 text-sm text-slate-700 whitespace-pre-wrap">{exp.description}</div>
                ) : null}
              </div>
            ))}
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-0.5 text-sm font-medium text-slate-800">{interview.departmentName || "—"}</div>
              </div>
            </div>
          </div>
