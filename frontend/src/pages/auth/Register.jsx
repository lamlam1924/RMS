      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4 pt-24">
        <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Tạo tài khoản mới - Bước {step}/3</p>
          </div>
          ...
          {step === 1 && (
            <form onSubmit={handleSendOtp} className="space-y-6">
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">Nhập email để nhận mã xác thực</p>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center">
            ...
            <a href="/login" className="text-blue-600 font-semibold hover:text-blue-700 hover:underline">Đăng nhập ngay</a>
          </div>
        </div>
      </div>
    </>
