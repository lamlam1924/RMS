...
export const getPriorityBadge = (priority) => {
  const badges = {
    // Priority shape: rounded-md (vuông góc) — phân biệt với status rounded-full và SLA border-l stripe
    // P1 — Solid đỏ đậm: tự nó nổi, không cần animation
    1: {
      label: 'Khẩn cấp',
      icon: '🔥',
      color: '#dc2626',
    ...
    // P2 — Solid hổ phách: đủ nặng, không lẫn với pastel của status
    2: {
      label: 'Cao',
      icon: '⚡',
      color: '#b45309',
    ...
    // P3 — Neutral slate: thông tin, không cạnh tranh với status hay SLA
    3: {
      label: 'Bình thường',
      icon: '',
      color: '#475569',
